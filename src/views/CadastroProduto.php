...
<body>
    ...
    <div class="container" align="center">
        <form class="form" name="cadProduto" method="POST" action="../controllers/products/productsController.php">
            ...
            <input type="text" name="descricao" class="input" placeholder="Descrição" required>
            <input type="text" name="preco" class="input" placeholder="Preço" required>
            <input type="text" name="estoque" class="input" placeholder="Estoque" required>
