...
<body style="background: linear-gradient(123.7deg, #7236AD -33.13%, #313C59 111.98%); height: 20px;">
    ...
    <br>
        ...
        <input class="form-check-input" type="checkbox" value="" id="invalidCheck" required>
            <label class="form-check-label fn" for="invalidCheck">
            Ao cadastrar você irá concordar com a nossa <a href="">politica de dados</a>
            <hr>
            <h4>Já possui uma conta? <a href="login.php">Sign in</a></h4>
        </div>
        <script type="text/javascript" src="vanilla-tilt.js"></script>
        <script>VanillaTilt.init(document.querySelectorAll(".ex2"));</script>
        <script>VanillaTilt.init(document.querySelectorAll(".ex3"));</script>
